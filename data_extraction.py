...
# Get the repository root directory from GITHUB_WORKSPACE
repo_root = os.getenv('GITHUB_WORKSPACE', os.getcwd())
input_file_path = os.path.join(repo_root, input_file_name)
output_file_path = os.path.join(repo_root, output_file_name)
